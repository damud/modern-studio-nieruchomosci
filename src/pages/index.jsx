			...
			<StyledList>
				...
				<li>
					...
					<p>
						...
						zróżnicowanych kompetencjach, dzięki którym świetnie się uzupełniamy
					</p>
				</li>
			</StyledList>
		</AdvantagesSection>
		...
		<ServicesSection>
			...
			<StyledList>
				...
				<li>
					<h3>Home staging</h3>
					<p>
						Modna i funkcjonalna metamorfoza wnętrza mieszkania, domu czy biura
						podnosi atrakcyjność oferty na rynku.
					</p>
				</li>
				<li>
			...
			<div>
				<StyledReview>
					<p>
						...
						proces był przeprowadzony bardzo sprawnie, profesjonalnie i dla nas
						jako klientów bezboleśnie. Ania ma prawdziwy dar tłumaczenia
